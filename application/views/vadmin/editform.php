                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="layer-0-2 wow slideInUp">
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" class="form-control" name="emailadmin" id="emailadmin" value="<?= $email ?>" placeholder="Masukan Email Admin" required />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="id_record" id="id_record" value=<?= $id_todo; ?> />
                                        <input onclick="return confirm('Anda yakin untuk melakukan perubahan data admin?')" type="submit" name="submit" class="btn btn-primary btn-user btn-block" value="Konfirmasi perubahan" />
