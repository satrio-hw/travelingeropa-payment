                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php site_url('cpaket/paket/edit') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col">
                            ...
                            <select name="upgrade_kamar" value="<?= $paket->upgrade_kamar ?>" class="form-control <?php echo form_error('upgrade_kamar') ? 'is-invalid' : '' ?>">
                        ...
                        <div class="col">
                            ...
                            <select name="visa" value="<?= $paket->visa ?>" class="form-control <?php echo form_error('visa') ? 'is-invalid' : '' ?>">
                                <option value="">--Pilih--</option>
                                <option value="Ya">Ya</option>
                                <option value="Tidak">Tidak</option>
                            </select>
                        ...
                        <div class="col">
                            ...
                            <select name="asuransi" value="<?= $paket->asuransi ?>" class="form-control <?php echo form_error('asuransi') ? 'is-invalid' : '' ?>">
                                <option value="">--Pilih--</option>
                                <option value="Ya">Ya</option>
                                <option value="Tidak">Tidak</option>
                            </select>
                        ...
                        <div class="col">
                            ...
                            <select name="simcard" value="<?= $paket->simcard ?>" class="form-control <?php echo form_error('simcard') ? 'is-invalid' : '' ?>">
                                <option value="">--Pilih--</option>
                                <option value="Ya">Ya</option>
                                <option value="Tidak">Tidak</option>
                            </select>
                        ...
                        <div class="col">
                            ...
                            <select name="upgrade_bagasi" value="<?= $paket->upgrade_bagasi ?>" class="form-control <?php echo form_error('upgrade_bagasi') ? 'is-invalid' : '' ?>">
                                <option value="">--Pilih--</option>
                                <option value="Ya">Ya</option>
                                <option value="Tidak">Tidak</option>
                            </select>
