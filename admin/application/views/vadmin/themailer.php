                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><b>Email Sender</b></label>
                                        <input type="email" class="form-control" name="emailsender" id="emailsender" placeholder="Masukan Email Sender Baru" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password1" id="password1" minlength=6 placeholder="Masukan Password" required />
                                        <?= form_error('password1', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <label><b>Konfirmasi Password Baru</b></label>
                                        <input type="password" class="form-control" name="password2" id="password2" minlength=6 placeholder="Ketikan password kembali" required />
                                        <?= form_error('password2', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <input type="submit" name="submitmailer" class="btn btn-primary btn-user" value="Ubah Sender" />
                                    </div>
                                </div>
                            </div>
                        </div>
