          ...
          <div class="col-md-12">
                                                ...
                                                <div class="row form-group">
													<div class="col-md-12">
														...
														<input type="number" class="form-control" name="jumlah_pserta" id="jumlah_pserta" placeholder="Jumlah peserta" required />
													</div>
                                                </div>
                                                
                                                <div class="col-md-offset-2 col-md-8">
												<input type="submit" name = "lanjut" class="btn btn-primary btn-block" value="Next"/>
                        </div>
                    </div>
          </form>
